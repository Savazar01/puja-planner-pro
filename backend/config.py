...
class Settings(BaseSettings):
    ...
    agent_planner_llm: str = Field("gemini-3.1-flash-lite-preview", alias="AGENT_PLANNER_LLM")
    agent_concierge_llm: str = Field("gemini-3.1-flash-lite-preview", alias="AGENT_CONCIERGE_LLM")
    agent_finder_llm: str = Field("gemini-3.1-flash-lite-preview", alias="AGENT_FINDER_LLM")
    agent_scribe_llm: str = Field("gemini-3.1-flash-lite-preview", alias="AGENT_SCRIBE_LLM")
    agent_supplies_llm: str = Field("gemini-3.1-flash-lite-preview", alias="AGENT_SUPPLIES_LLM")
